...
namespace Manhattanville
{
    ...
    {
        public GeometryNode boxNode1, boxNode2;
        ...
        public DataRepresentation(GraphicsDevice graphicsDevice, SpriteFont spriteFont, Color color)
            : base()
        {
        ...
        public void Update(double gameTime)
        {
            ...
            //boxTransNode1.Rotation = Quaternion.CreateFromAxisAngle(new Vector3(1, 0, 0), rotationAngle);
...
///////// WORKING VERSION BEFORE SCALING UP
